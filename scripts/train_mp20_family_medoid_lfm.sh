...
RUN_NAME="${RUN_NAME:-mp20_pbc_balanced_z8_family_medoid_lfm}"
...
exec "$PYTHON_BIN" src/train_diffusion.py \
  data=mp20_only diffusion_module=ldm_family_medoid \
  ...
  +diffusion_module.autoencoder_module_target=src.models.vae_pbc_module.PBCVariationalAutoencoderLitModule \
